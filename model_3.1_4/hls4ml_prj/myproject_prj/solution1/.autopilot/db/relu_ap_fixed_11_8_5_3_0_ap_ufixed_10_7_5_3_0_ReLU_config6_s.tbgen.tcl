set moduleName relu_ap_fixed_11_8_5_3_0_ap_ufixed_10_7_5_3_0_ReLU_config6_s
set isTopModule 0
...
set C_modelName {relu<ap_fixed<11, 8, 5, 3, 0>, ap_ufixed<10, 7, 5, 3, 0>, ReLU_config6>}
...
set C_modelArgList {
	...
	{ data_22_val int 11 regular  }
	{ data_49_val int 11 regular  }
	{ data_55_val int 11 regular  }
	{ data_59_val int 11 regular  }
	{ data_63_val int 11 regular  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "data_0_val", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "data_22_val", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "data_49_val", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "data_55_val", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "data_59_val", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "data_63_val", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ data_6_val sc_in sc_lv 11 signal 2 } 
	{ data_7_val sc_in sc_lv 11 signal 3 } 
	{ data_22_val sc_in sc_lv 11 signal 4 } 
	{ data_49_val sc_in sc_lv 11 signal 5 } 
	{ data_55_val sc_in sc_lv 11 signal 6 } 
	{ data_59_val sc_in sc_lv 11 signal 7 } 
	{ data_63_val sc_in sc_lv 11 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_ready", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "ready", "bundle":{"name": "ap_ready", "role": "default" }} , 
 	...
 	{ "name": "data_22_val", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "data_22_val", "role": "default" }} , 
 	{ "name": "data_49_val", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "data_49_val", "role": "default" }} , 
 	{ "name": "data_55_val", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "data_55_val", "role": "default" }} , 
 	{ "name": "data_59_val", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "data_59_val", "role": "default" }} , 
 	{ "name": "data_63_val", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "data_63_val", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	data_22_val { ap_none {  { data_22_val in_data 0 11 } } }
	data_49_val { ap_none {  { data_49_val in_data 0 11 } } }
	data_55_val { ap_none {  { data_55_val in_data 0 11 } } }
	data_59_val { ap_none {  { data_59_val in_data 0 11 } } }
	data_63_val { ap_none {  { data_63_val in_data 0 11 } } }
}
