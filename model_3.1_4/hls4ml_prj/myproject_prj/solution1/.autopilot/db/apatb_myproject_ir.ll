; ModuleID = '/home/hep/lr1424/hls4ml-tutorial_OPENML/model_3.1_4/hls4ml_prj/myproject_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>" = type { %"struct.ap_fixed_base<13, 6, true, AP_TRN, AP_WRAP, 0>" }
%"struct.ap_fixed_base<13, 6, true, AP_TRN, AP_WRAP, 0>" = type { %"struct.ssdm_int<13, true>" }
...
define void @apatb_myproject_ir(%"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %input_16, %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="5" "partition" %layer20_out) local_unnamed_addr #0 {
entry:
  %input_16_copy3 = alloca i208, align 512
  ...
  %0 = bitcast %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"* %input_16 to [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]*
  %1 = bitcast %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"* %layer20_out to [5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]*
  call void @copy_in([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %0, i208* nonnull align 512 %input_16_copy3, [5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %1, i12* nonnull align 512 %layer20_out_copy_0, i12* nonnull align 512 %layer20_out_copy_1, i12* nonnull align 512 %layer20_out_copy_2, i12* nonnull align 512 %layer20_out_copy_3, i12* nonnull align 512 %layer20_out_copy_4)
  call void @apatb_myproject_hw(i208* %input_16_copy3, i12* %layer20_out_copy_0, i12* %layer20_out_copy_1, i12* %layer20_out_copy_2, i12* %layer20_out_copy_3, i12* %layer20_out_copy_4)
  call void @copy_back([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %0, i208* %input_16_copy3, [5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]* %1, i12* %layer20_out_copy_0, i12* %layer20_out_copy_1, i12* %layer20_out_copy_2, i12* %layer20_out_copy_3, i12* %layer20_out_copy_4)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>.71"(i208* nocapture "orig.arg.no"="0" "unpacked"="0.0" %dst, i64 %dst_shift, [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
  %0 = icmp eq [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"], [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %src, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a16struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>.68"(i208* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst, [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #3 {
entry:
  %0 = icmp eq [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>.71"(i208* %dst, i64 0, [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 16)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_in([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* noalias readonly "orig.arg.no"="0" "unpacked"="0", i208* noalias nocapture align 512 "orig.arg.no"="1" "unpacked"="1.0", [5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]* noalias readonly "orig.arg.no"="2" "unpacked"="2", i12* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.0" %_0, i12* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.1" %_1, i12* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.2" %_2, i12* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.3" %_3, i12* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.4" %_4) #4 {
entry:
  call void @"onebyonecpy_hls.p0a16struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>.68"(i208* align 512 %1, [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %0)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i208* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0" %src, i64 %src_shift, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
  %0 = icmp eq [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  %dst.addr.0.0.06 = getelementptr [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"], [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %dst, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a16struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i208* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src) #3 {
entry:
  %0 = icmp eq [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i208* %src, i64 0, i64 16)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_out([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0", i208* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0", [5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="2" "unpacked"="2", i12* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.0" %_0, i12* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.1" %_1, i12* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.2" %_2, i12* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.3" %_3, i12* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.4" %_4) #5 {
entry:
  call void @"onebyonecpy_hls.p0a16struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %0, i208* align 512 %1)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_back([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0", i208* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0", [5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="2" "unpacked"="2", i12* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.0" %_0, i12* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.1" %_1, i12* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.2" %_2, i12* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.3" %_3, i12* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.4" %_4) #5 {
entry:
  call void @"onebyonecpy_hls.p0a5struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>.58"([5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]* %2, i12* align 512 %_0, i12* align 512 %_1, i12* align 512 %_2, i12* align 512 %_3, i12* align 512 %_4)
  ret void
}
...
entry:
  %6 = alloca [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]
  %7 = alloca [5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]
  call void @copy_out([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %6, i208* %0, [5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]* %7, i12* %1, i12* %2, i12* %3, i12* %4, i12* %5)
  %8 = bitcast [16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %6 to %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"*
  %9 = bitcast [5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]* %7 to %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"*
  call void @myproject_hw_stub(%"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"* %8, %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"* %9)
  call void @copy_in([16 x %"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"]* %6, i208* %0, [5 x %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"]* %7, i12* %1, i12* %2, i12* %3, i12* %4, i12* %5)
  ret void
}

declare void @myproject_hw_stub(%"struct.ap_fixed<13, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<12, 6, AP_TRN, AP_WRAP, 0>"* noalias nocapture nonnull)
